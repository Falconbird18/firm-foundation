class Container {
  ...
  constructor(options = {}) {
    ...
    this.tintOpacity =
      options.tintOpacity !== undefined
        ? options.tintOpacity
        : window.glassControls.tintOpacity;
  ...
  `;
    ...
    gl.uniform1f(blurRadiusLoc, window.glassControls.blurRadius);
    gl.uniform1f(borderRadiusLoc, this.borderRadius);
    gl.uniform1f(warpLoc, this.warp ? 1.0 : 0.0);
    gl.uniform1f(edgeIntensityLoc, window.glassControls.edgeIntensity);
    gl.uniform1f(rimIntensityLoc, window.glassControls.rimIntensity);
    gl.uniform1f(baseIntensityLoc, window.glassControls.baseIntensity);
    gl.uniform1f(edgeDistanceLoc, window.glassControls.edgeDistance);
    gl.uniform1f(rimDistanceLoc, window.glassControls.rimDistance);
    gl.uniform1f(baseDistanceLoc, window.glassControls.baseDistance);
    gl.uniform1f(cornerBoostLoc, window.glassControls.cornerBoost);
    gl.uniform1f(rippleEffectLoc, window.glassControls.rippleEffect);
